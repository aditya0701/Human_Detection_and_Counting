...
def social_distancing_view(frame, distances_mat, boxes, risk_count):
    ...
    cv2.putText(pad, "-- Total Humans : " + str(risk_count[2]+risk_count[1]+risk_count[0]) + " people", (50,  120), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 1)
    if risk_count[0] >= config.Threshold:
        #config.Threshold
        cv2.putText(pad, "-ALERT: Violations over limit-", (750,  30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
